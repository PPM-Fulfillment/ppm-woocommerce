...
1. You can download (as a zip) from the [GitHub Repository](https://github.com/PPM-Fulfillment/ppm-woocommerce) by clicking the "Clone or Download" button, then selecting "Download as ZIP". This will download a compressed `.zip` file. Unpackage it into `wp-content/plugins/ppm-woocommerce`.
...
Unfortunately, no. But you can contact PPM Fulfillment to get set up for third-party fulfillment with them at: https://home.ppmfulfillment.com/contact-us/
